...
namespace WebsiteQuanLyLamViecNhom.Data.Migrations
{
    ...
    [Migration("20240206024613_updateImageAndEmailContributionForStudent")]
    partial class updateImageAndEmailContributionForStudent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebsiteQuanLyLamViecNhom.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebsiteQuanLyLamViecNhom.Models.Task", b =>
                {
                    ...
                    b.Property<string>("AttachmentLinksJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebsiteQuanLyLamViecNhom.Models.Student", b =>
                {
                    ...
                    b.Property<string>("StudentImgId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebsiteQuanLyLamViecNhom.Models.Message", b =>
                {
                    b.HasOne("WebsiteQuanLyLamViecNhom.Models.BaseApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
